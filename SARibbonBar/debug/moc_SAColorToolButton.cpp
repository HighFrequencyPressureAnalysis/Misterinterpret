...
struct qt_meta_stringdata_CLASSSAColorToolButtonENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSAColorToolButtonENDCLASS = QtMocHelpers::stringData(
    "SAColorToolButton",
    "colorClicked",
    "",
    "color",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSAColorToolButtonENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SAColorToolButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSAColorToolButtonENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSAColorToolButtonENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSAColorToolButtonENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void SAColorToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SAColorToolButton::*)(const QColor & , bool );
            if (_t _q_method = &SAColorToolButton::colorClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SAColorToolButton::*)(const QColor & );
            if (_t _q_method = &SAColorToolButton::colorChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *SAColorToolButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSAColorToolButtonENDCLASS.stringdata0))
