...
struct qt_meta_stringdata_CLASSSAFramelessHelperENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSAFramelessHelperENDCLASS = QtMocHelpers::stringData(
    "SAFramelessHelper"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSAFramelessHelperENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SAFramelessHelper::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSAFramelessHelperENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSAFramelessHelperENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSAFramelessHelperENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SAFramelessHelper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSAFramelessHelperENDCLASS.stringdata0))
