...
struct qt_meta_stringdata_CLASSSAColorPaletteGridWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSAColorPaletteGridWidgetENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSAColorPaletteGridWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SAColorPaletteGridWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSAColorPaletteGridWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSAColorPaletteGridWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSAColorPaletteGridWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void SAColorPaletteGridWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SAColorPaletteGridWidget::*)(const QColor & );
            if (_t _q_method = &SAColorPaletteGridWidget::colorClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SAColorPaletteGridWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSAColorPaletteGridWidgetENDCLASS.stringdata0))
