...
struct qt_meta_stringdata_CLASSSARibbonStackedWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSARibbonStackedWidgetENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSARibbonStackedWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SARibbonStackedWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSARibbonStackedWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSARibbonStackedWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSARibbonStackedWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void SARibbonStackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SARibbonStackedWidget::hidWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SARibbonStackedWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSARibbonStackedWidgetENDCLASS.stringdata0))
