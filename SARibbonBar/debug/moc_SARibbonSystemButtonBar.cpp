...
struct qt_meta_stringdata_CLASSSARibbonSystemButtonBarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSARibbonSystemButtonBarENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSARibbonSystemButtonBarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SARibbonSystemButtonBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSARibbonSystemButtonBarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSARibbonSystemButtonBarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSARibbonSystemButtonBarENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SARibbonSystemButtonBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSARibbonSystemButtonBarENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSSARibbonSystemToolButtonENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSARibbonSystemToolButtonENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSARibbonSystemToolButtonENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SARibbonSystemToolButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSARibbonSystemToolButtonENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSARibbonSystemToolButtonENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSARibbonSystemToolButtonENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSARibbonSystemToolButtonENDCLASS.stringdata0))
        return static_cast<void*>(this);
