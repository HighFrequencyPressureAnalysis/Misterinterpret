...
struct qt_meta_stringdata_CLASSSARibbonActionsManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSARibbonActionsManagerENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSARibbonActionsManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SARibbonActionsManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSARibbonActionsManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSARibbonActionsManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSARibbonActionsManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void SARibbonActionsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SARibbonActionsManager::actionTagChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SARibbonActionsManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSARibbonActionsManagerENDCLASS.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSSARibbonActionsManagerModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSARibbonActionsManagerModelENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSARibbonActionsManagerModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SARibbonActionsManagerModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSARibbonActionsManagerModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSARibbonActionsManagerModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSARibbonActionsManagerModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSARibbonActionsManagerModelENDCLASS.stringdata0))
        return static_cast<void*>(this);
