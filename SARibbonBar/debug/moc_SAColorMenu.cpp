...
struct qt_meta_stringdata_CLASSSAColorMenuENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSAColorMenuENDCLASS = QtMocHelpers::stringData(
    "SAColorMenu",
    "selectedColor",
    "",
    "c",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSAColorMenuENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SAColorMenu::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSAColorMenuENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSAColorMenuENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSAColorMenuENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void SAColorMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SAColorMenu::*)(const QColor & );
            if (_t _q_method = &SAColorMenu::selectedColor; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SAColorMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSAColorMenuENDCLASS.stringdata0))
