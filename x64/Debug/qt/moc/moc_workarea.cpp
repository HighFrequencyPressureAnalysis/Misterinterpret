...
QT_MOC_LITERAL(1, 9, 11), // "clearChoose"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "WorkArea\0clearChoose\0"
};
...
void WorkArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WorkArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clearChoose(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject WorkArea::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_WorkArea.data,
    qt_meta_data_WorkArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
