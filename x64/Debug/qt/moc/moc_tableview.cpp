...
QT_MOC_LITERAL(1, 10, 16), // "sendSelectSignal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9), // "IntVector"
QT_MOC_LITERAL(4, 38, 15), // "sendSelectRange"
QT_MOC_LITERAL(5, 54, 14) // "QItemSelection"

    },
    "TableView\0sendSelectSignal\0\0IntVector\0"
    "sendSelectRange\0QItemSelection"
};
...
void TableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSelectSignal((*reinterpret_cast< const IntVector(*)>(_a[1]))); break;
        case 1: _t->sendSelectRange((*reinterpret_cast< const QItemSelection(*)>(_a[1])),(*reinterpret_cast< const QItemSelection(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (TableView::*)(const IntVector & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TableView::sendSelectSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TableView::sendSelectSignal(const IntVector & _t1)
{
